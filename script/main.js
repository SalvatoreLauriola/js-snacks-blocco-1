...
for (var i = 0; i  < 5; i++) {
    ...
    var randomSurnameNumber = Math.floor(Math.random() *  (( cognomi.length - 1 )  - 0  + 1) + 0);

    var newFullName = nomi[randomNameNumber] + '' + cognomi[randomSurnameNumber];

    falsi.push(newFullName);
